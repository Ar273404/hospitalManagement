...
const Hero = ({ title, imageURL }) => {
  return (
    <div className="font-sans mt-24">
      <div className="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-slate-300">
        <div className="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
          ...
          <p class="text-gray-800 mt-6 text-base leading-relaxed">
            Book your appointment with our experienced medical professionals
            easily and conveniently. Your health is our priority. Join our
        ...
        <div className="lg:h-[480px] flex items-center">
          <img
            src="https://st2.depositphotos.com/20363444/43158/i/450/depositphotos_431581684-stock-photo-doctor-hand-pocket-looking-laptop.jpg"
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-6 px-4 my-12">
        <div className="boxshadow1 bg-gray-100 p-6 rounded-md">
          <svg
